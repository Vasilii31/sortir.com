...
//             Caution: This may reveal if a user is registered or not.
        ...
        //test avec email sans twig -> ne marche pas non plus
//        $email = (new Email())
//            ->from('no-reply@demomailtrap.co')
//            ->to('anything@demomailtrap.co')
//            ->subject('Test direct controller')
//            ->text('Ceci est un test depuis le controller');
        ...
        //ce test a marché mais on ne recoit toujours pas le mail
        //dd('email sent !');
